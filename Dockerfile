...
RUN make clean && make -j$(nproc) EXTRACFLAGS='-DHTMLPATH=\"/usr/share/dump1090/html\"' dump1090 view1090
...
COPY --from=builder /src/public_html /usr/share/dump1090/html
COPY --from=builder /src/public_html /app/public_html
COPY entrypoint.sh /entrypoint.sh
RUN chmod +x /entrypoint.sh

# Ports:
# 8080  - HTTP Map Webserver
# 30001 - Raw input
# 30002 - Raw output
